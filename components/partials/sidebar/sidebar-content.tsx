	...
	return (
		<aside
			onMouseEnter={() =>
				...
				setHoverConfig({ hovered: true })
			}
			onMouseLeave={() =>
				config.sidebar === "classic" &&
				setHoverConfig({ hovered: false })
			}
			className={cn(
				...
				{
					"w-[72px]":
						config.collapsed && config.sidebar !== "compact",
			...
			<div className=" relative  flex flex-col h-full  ">
				{config.sidebarBgImage !== undefined && (
					<div
						...
						style={{
							backgroundImage: `url(${config.sidebarBgImage})`,
						}}
					></div>
				)}
				{children}
